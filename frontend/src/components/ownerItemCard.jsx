      ...
      <div className="flex flex-col justify-between p-6 flex-1">
        <div className="space-y-1">
          <div className="flex justify-between items-start">
            <h2 className="text-xl font-black text-gray-900 uppercase tracking-tighter group-hover:text-[#ff4d2d] transition-colors">
              {data.name}
            </h2>
          ...
          <p className="text-gray-500 text-xs font-medium mt-2 line-clamp-1">
            {data.description || "Freshly prepared and delicious."}
          </p>
        </div>
