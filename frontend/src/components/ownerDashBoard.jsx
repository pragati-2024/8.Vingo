...
function OwnerDashboard() {
  ...
  const dedupedActiveShopItems = useMemo(() => {
              ...
              {myShops && myShops.length > 0 ? (
                  ...
                  >
                    ...
                    <button
                      ...
                      onClick={(e) => {
                        ...
                        navigate(`/create-edit-shop?shopId=${shop?._id}`);
                      }}
                      className="absolute top-4 right-4 z-20 w-10 h-10 rounded-2xl bg-white/95 backdrop-blur-sm border border-gray-100 shadow-md flex items-center justify-center text-gray-800 hover:text-[#ff4d2d] transition-colors"
                      aria-label={`Edit ${shop?.name || "shop"}`}
                      title="Edit shop"
                    >
                      <FaPen size={16} />
                    </button>
                ...
                <div className="w-full py-16 text-center bg-gray-50/50 rounded-[40px] border border-dashed border-gray-200">
                  ...
                  <button
                    ...
                    className="mt-4 text-[#ff4d2d] font-black uppercase text-xs tracking-[0.2em] border-b-2 border-[#ff4d2d] pb-1"
                  >
                    Open your first establishment
                  </button>
                </div>
              )}
            </div>
            ...
            {activeShop ? (
                  ...
                  <div className="flex justify-between items-center mb-10">
                    ...
                    <div className="flex items-center gap-3">
                      <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="bg-gray-900 text-white px-6 py-4 rounded-2xl font-black uppercase tracking-widest text-xs shadow-xl hover:bg-[#ff4d2d] transition-all"
                        onClick={() => navigate("/create-edit-shop")}
                      >
                        <FaPen className="inline mr-2" /> Edit Shop
                      </motion.button>
              ...
              <div className="w-full py-20 text-center">
                <p className="text-gray-300 font-black uppercase tracking-[0.3em] text-sm italic">
                  Select a shop above to start managing your business
                </p>
              </div>
            )}
          </AnimatePresence>
