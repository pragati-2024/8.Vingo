...
function AddItem() {
  ...
  return (
    <div className="flex justify-center flex-col items-center p-6 subtle-star-pattern bg-white/95 backdrop-blur-[2px] min-h-screen pt-20">
      <div
        className="absolute top-8 left-8 z-[10] cursor-pointer hover:scale-110 transition-transform"
        onClick={() => navigate("/")}
      >
        ...
        <form className="space-y-8 relative z-10" onSubmit={handleSubmit}>
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full px-6 py-4 bg-gray-50 border-2 border-transparent rounded-2xl focus:outline-none focus:border-[#ff4d2d] focus:bg-white transition-all font-bold text-gray-800"
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              ...
              <div className="w-full px-6 py-10 bg-gray-50 border-2 border-dashed border-gray-200 rounded-3xl flex flex-col items-center justify-center group-hover:border-[#ff4d2d] transition-all">
                <div className="text-gray-400 font-bold text-xs uppercase tracking-widest mb-2">
            ...
            {frontendImage && (
              ...
              >
                <img
                  src={frontendImage}
                  alt="Preview"
                  className="w-full h-52 object-cover rounded-3xl border-4 border-white shadow-lg"
                />
              </Motion.div>
            )}
          </div>
