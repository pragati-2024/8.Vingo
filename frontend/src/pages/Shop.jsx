    ...
    <div className="min-h-screen bg-transparent">
      ...
      <div className="w-full subtle-star-pattern bg-white/95 backdrop-blur-[2px]">
        <div className="max-w-7xl mx-auto px-6 py-16">
          <h2 className="flex items-center justify-center gap-3 text-3xl font-black mb-12 text-gray-900 uppercase tracking-tight">
          ...
          {items.length > 0 ? (
            ...
            <div className="flex flex-col items-center gap-4 py-20">
              <p className="text-center text-gray-400 text-xl font-bold uppercase tracking-tighter">
                No Items Available in this shop yet 😔
              </p>
              <button
                onClick={() => navigate("/")}
                className="text-[#ff4d2d] font-black uppercase text-xs tracking-widest border-b-2 border-[#ff4d2d] pb-1"
              >
                Explore other shops
              </button>
            </div>
