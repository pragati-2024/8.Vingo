...
function CheckOut() {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      const result = await axios.post(`${serverUrl}/api/order/place`, payload, {
  ...
  return (
    <div className="w-full min-h-screen bg-[#fffcfb] flex flex-col lg:flex-row">
          ...
          >
            ...
            <div className="relative mb-5">
              ...
              <textarea
                ...
                onKeyDown={(e) =>
                  e.key === "Enter" &&
                  (e.preventDefault(), getLatLngByAddress())
                }
          ...
          <div className="bg-white p-6 rounded-t-[2.5rem] shadow-[0_-20px_50px_rgba(0,0,0,0.1)] border-t border-gray-100">
            ...
            <div className="flex flex-col gap-4 mb-6">
              <input
                ...
                value={userName}
                onChange={(e) => setUserName(e.target.value)}
                className="px-4 py-3 bg-gray-50 rounded-xl text-xs font-bold outline-none"
              />
              <input
                type="text"
                placeholder="Mobile"
              ...
              />
              <textarea
                className="w-full p-4 bg-gray-50 rounded-xl text-xs h-20 outline-none resize-none"
                value={addressInput}
                onChange={(e) => setAddressInput(e.target.value)}
                placeholder="Address..."
              />
            ...
            <button
              onClick={getCurrentLocation}
              className="w-full py-4 bg-[#ff4d2d] text-white rounded-2xl font-black text-[10px] uppercase tracking-widest shadow-lg shadow-orange-100"
            >
              Confirm Location
            </button>
          </div>
      ...
      <div className="w-full lg:w-[35%] bg-white p-6 md:p-10 flex flex-col shadow-[-20px_0_60px_rgba(0,0,0,0.02)] relative lg:h-screen overflow-y-auto">
          ...
          {cartItems.map((item, idx) => (
            ...
            >
              <div className="flex gap-4">
                ...
                <div>
                  <p className="font-black text-gray-800 group-hover:text-[#ff4d2d] transition-colors">
                    {item.name}
                  </p>
        ...
        <div className="space-y-4 mb-10 bg-gray-50/50 p-8 rounded-[2.5rem] border border-gray-100">
          ...
          <div className="flex justify-between text-gray-500 font-bold text-sm">
            <span className="flex items-center gap-2">
              Delivery Fee <FaInfoCircle className="text-gray-300" size={12} />
            </span>
          ...
          <div className="pt-6 mt-2 border-t border-gray-200 flex justify-between items-center">
            <div className="flex flex-col">
              ...
              <span className="text-4xl font-black text-gray-900 mt-1 tracking-tighter">
                ₹{finalAmount}
              </span>
            </div>
        ...
        <div className="mb-10">
          <p className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-6 ml-2">
            Payment Gateway
          </p>
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <span className="text-[10px] font-black mt-3 uppercase tracking-widest">
                Cash on Delivery
              </span>
            </motion.button>
            <motion.button
