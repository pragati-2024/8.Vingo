        ...
        {cartItems?.length == 0 ? (
          <div className="flex flex-col items-center justify-center py-20 bg-white rounded-3xl border border-dashed border-orange-200">
            <p className="text-gray-400 text-lg font-medium italic">
              Your cart is hungry... add some food! 🍕
            </p>
            <button
              onClick={() => navigate("/")}
              className="mt-6 text-[#ff4d2d] font-bold hover:underline"
            >
              Browse Restaurants
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="bg-white p-6 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 relative overflow-hidden">
                ...
                {couponApplied && (
                  <p className="text-[10px] text-green-600 font-bold mt-2 uppercase tracking-widest">
                    You saved ₹{discount} with SAVE50!
                  </p>
                )}
              </div>
              ...
              <div className="bg-white p-6 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100">
                <h3 className="text-gray-900 font-black uppercase text-xs tracking-widest mb-6">
                  Bill Details
                </h3>
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between text-sm text-gray-500 font-medium">
                    <span className="flex items-center gap-1">
                      Delivery Fee{" "}
                      <FaInfoCircle size={10} className="text-gray-300" />
                    </span>
                    <span
                      className={
                  ...
                  <div className="pt-4 border-t-2 border-gray-50 flex justify-between items-center">
                    ...
                    <span className="text-3xl font-black text-[#ff4d2d] drop-shadow-sm">
                      ₹{finalTotal}
                    </span>
                  </div>
                </div>
